        ...
        <div className="container mx-auto flex flex-col items-center justify-center  gap-4 py-20">
          ...
          <div className="border p-1 rounded-full border-gray-300 flex items-center justify-center">
            <button
              ...
              className={`px-4 py-2 rounded-full ${filter === "products" ? "gradient text-white font-semibold" : "text-gray-700 "}`}
            >
              Products
            </button>
            <button
              onClick={() => setFilter("cart")}
              className={`px-4 py-2 rounded-full ${filter === "cart" ? "gradient text-white font-semibold" : "text-gray-700 "}`}
            >
              Cart ({cart.length})
            </button>
          </div>
