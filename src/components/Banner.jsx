        ...
        <div className="container mx-auto grid  md:grid-cols-2 items-center py-20 gap-10">
          <div className="left space-y-4">
            <div className="w-fit px-4 py-1 flex items-center gap-2 rounded-full bg-[#E1E7FF]">
              ...
              <p className=" font-semibold bg-gradient-to-l from-[#9514FA] to-[#4F39F6] text-transparent bg-clip-text">New: AI-Powered Tools Available</p>
            </div>
            ...
            <div className="flex gap-4 items-center justify-start ">
              <button className=" font-semibold bg-gradient-to-l from-[#9514FA] to-[#4F39F6] text-white px-4 py-2 rounded-full cursor-pointer">Explore Products</button>
              <button className="flex items-center justify-start gap-2 border px-4 py-2 rounded-full  border-[#9514FA] cursor-pointer">
                <img src={play} alt="Play" />
                <span className="gradient text-transparent bg-clip-text font-bold">Watch video</span>
              </button>
            </div>
          </div>
          <div className="right ">
            <img src={bannerImg} alt="Banner" className=" w-full object-center object-cover" />
          </div>
        </div>
      </div>
    </>
