...
const Banner = () => {
  return (
    <>
      <div>
        <div className="container mx-auto grid  md:grid-cols-2 items-center justify-between py-10 md:py-20 gap-10 ">
          <div className="left space-y-4 ">
            {/* header section  */}
            <div className="w-fit px-4 py-1 flex items-center gap-2 rounded-full bg-[#E1E7FF] mx-auto md:mx-0">
